...
def main():
    ...
    st.set_page_config(
        layout="wide",
        page_title="Medical Document Graph Analyzer",
        page_icon=":graph:"
    )
    ...
    st.title("Realtime GraphRAG App to converse with Medical PDF")
    ...
    if graph is not None:
        ...
        if uploaded_file is not None and 'qa_chain' not in st.session_state:
