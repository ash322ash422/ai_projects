...
Extract "Terms and Conditions" (clause list + any tables present) from a
...
TARGET_HEADING = "TERM AND CONDITION"
...
# Find page that contains heading
def find_page(pages: list, heading: str, threshold: float = 0.8) -> tuple:
    ...
    it's cleaner and immune to false positives from body text. Falls back
    to fuzzy-matching leading page text only if a page has no classified
    headings at all (e.g. paragraphs/roles weren't available for that doc).
    """
